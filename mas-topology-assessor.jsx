...
// ── System prompt for topology assessment ─────────────────────────────────────
    ...
    try {
      const resp = await fetch("https://api.anthropic.com/v1/messages", {
        ...
        body: JSON.stringify({
          ...
          messages: [{ role: "user", content: `Assess this multi-agent topology:\n\n${input}` }],
        }),
      });
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
          ...
          <div>
            ...
            <div style={{ fontSize: "9px", color: "#3A3A5C", letterSpacing: "0.12em", marginTop: "1px" }}>
              KONTEX · MFT v0.1 · 13 FAILURE MODES
            </div>
          </div>
        </div>
        <div style={{
          fontSize: "9px", color: "#2A2A40", letterSpacing: "0.08em",
          textAlign: "right", lineHeight: "1.8",
        }}>
          STATIC ANALYSIS<br/>NO EXECUTION REQUIRED
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Taxonomy legend */}
          <div style={{
            borderTop: "1px solid #13131F", padding: "14px 24px",
          }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                  ...
                  {result.recommended_changes?.map((change, i) => (
                    <div key={i} style={{
                      ...
                      borderLeft: `3px solid ${i === 0 ? "#FF4D4D" : i === 1 ? "#FF9500" : "#FBBF24"}`,
                      borderRadius: "8px",
                    }}>
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "8px" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                          <div style={{
                            ...
                            background: i === 0 ? "#FF4D4D22" : i === 1 ? "#FF950022" : "#FBBF2422",
                            display: "flex", alignItems: "center", justifyContent: "center",
                            fontSize: "10px", fontWeight: "700",
                            color: i === 0 ? "#FF4D4D" : i === 1 ? "#FF9500" : "#FBBF24",
                          }}>{change.priority}</div>
                        ...
                        <div style={{ display: "flex", gap: "4px" }}>
                          {change.fixes?.map(id => (
                            <span key={id} style={{
                              ...
                              background: `${CLASS_META[FAILURE_MODES[id]?.class]?.color}22` || "#13131F",
                              border: `1px solid ${Class_META?.[FAILURE_MODES[id]?.class]?.color}44` || "#1E1E30",
                              borderRadius: "3px",
        ...
        {!result && !loading && (
          <div style={{
            ...
            padding: "60px 40px", color: "#1A1A2E", gap: "16px",
            gridColumn: "1", // stays in left col when no result
          }} />
        )}
      </div>
    </div>
