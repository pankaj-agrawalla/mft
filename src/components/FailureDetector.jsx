  ...
  C1: {
    ...
    modes: {
      ...
      "C1.3": {
        ...
        signal: "Look for specific concrete facts (numbers, names, dates, statistics) that appear in multiple agents but cannot be traced to any tool call result or user-provided input.",
      },
    },
  },
  C2: {
    ...
    modes: {
      "C2.1": {
        ...
        signal: "Look for multiple agents making contradictory assertions about the same entity, metric, or state.",
      },
      "C2.2": {
        name: "Work Duplication Loop",
        severity: "MEDIUM",
        description: "Multiple agents independently perform identical or near-identical subtasks",
        signal: "Look for the same tool being called multiple times with similar inputs, or multiple agents producing nearly identical outputs on the same subtask.",
      },
      "C2.3": {
      ...
      "C2.4": {
        ...
        signal: "Look for agent outputs that contain specific data (prices, statistics, current facts) where no corresponding tool call appears in the trace.",
      },
    },
  },
  C3: {
    ...
    modes: {
      "C3.1": {
        ...
        signal: "Look for agents violating constraints or requirements that were explicitly stated earlier. Agents asking for information already provided.",
      },
      "C3.2": {
        name: "User Configuration Ignored",
        severity: "HIGH",
        description: "Agent proceeds without incorporating explicit user-provided configuration",
        signal: "Look for outputs that violate explicit user requirements present in the input — format requirements ignored, constraints violated, preferences not applied.",
      },
    },
  },
  C4: {
    ...
    modes: {
      "C4.1": {
        ...
        signal: "Look for evidence of agents blocking on each other in parallel topology, sequential dependencies violated, or obvious parallelism opportunities missed.",
      },
      "C4.2": {
        name: "Assurance Layer Absence",
        severity: "CRITICAL",
        description: "No verification agents — open-loop system with no error correction pathway",
        signal: "Check if any agent in the trace has a verification, evaluation, or critique role. If all agents are purely generative with no checking function, flag as open-loop.",
      },
    },
  },
  C5: {
    ...
    modes: {
      ...
      "C5.2": {
        ...
        signal: "Look for task completion claimed on outputs that clearly don't satisfy all stated requirements. Suspiciously fast completion on complex tasks.",
      },
    },
  },
};
...
export default function FailureDetector({ provider, apiKey }) {
  ...
  const analyzeTrace = async () => {
    ...
    const modesList = Object.entries(TAXONOMY).flatMap(([classId, cls]) =>
...
Return ONLY valid JSON:
{
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", minHeight: "calc(100vh - 47px)" }}>
        ...
        <div style={{ borderRight: "1px solid #1E1E2E", display: "flex", flexDirection: "column" }}>
          <div style={{
            ...
            <button
              ...
              style={{
                fontSize: "10px", color: "#FF8C00", background: "none",
                border: "1px solid #FF8C0033", borderRadius: "4px",
          ...
          <div style={{ padding: "16px 24px", flex: 1, display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            <textarea
              ...
              style={{
                ...
                background: "#0D0D15", border: "1px solid #1E1E2E", borderRadius: "8px",
                color: "#C8C8D8", fontFamily: "'IBM Plex Mono', monospace",
            ...
            <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
              ...
              {trace && (
                <button
                  ...
                  style={{
                    padding: "14px 18px", background: "#1A1A28",
            ...
            {error && (
              <div style={{
                padding: "12px", background: "#FF444411",
                border: "1px solid #FF444433", borderRadius: "6px",
          ...
          {/* Taxonomy Reference */}
          <div style={{ borderTop: "1px solid #1A1A28", padding: "16px 24px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          {loading && (
            <div style={{
              ...
              <div style={{
                ...
                border: "2px solid #1E1E2E", borderTop: "2px solid #FF8C00",
          ...
          {results && (
            <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
              {/* Results Header */}
              <div style={{ padding: "16px 24px", borderBottom: "1px solid #1A1A28", background: "#0D0D15" }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "12px" }}>
                  ...
                  <div style={{
                    ...
                    color: riskColors[results.risk_level], letterSpacing: "0.1em",
                  }}>
              ...
              {/* Tabs */}
              <div style={{ display: "flex", borderBottom: "1px solid #1A1A28", padding: "0 24px" }}>
                {[
              ...
              <div style={{ flex: 1, overflowY: "auto", padding: "12px 24px 24px" }}>
                      ...
                      <div style={{ padding: "12px 14px" }}>
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "6px" }}>
                          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                            <span style={{ fontSize: "9px", color: finding.class_color, fontWeight: "700", letterSpacing: "0.05em" }}>
                              {finding.mode_id}
                            </span>
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                            {finding.status === "DETECTED" && (
                              <span style={{
                                ...
                                background: sev.bg, border: `1px solid ${sev.border}66`,
                                borderRadius: "3px", color: sev.text, letterSpacing: "0.05em",
                              }}>
                                {finding.severity}
                              </span>
                            )}
                            <span style={{
                              ...
                              borderRadius: "3px", color: statusColor, letterSpacing: "0.05em",
                            }}>
                        ...
                        {finding.evidence && (
                          <div style={{
                            ...
                            border: "1px solid #1E1E2E", fontSize: "10px",
                        ...
                        {finding.recommendation && finding.status === "DETECTED" && (
                          <div style={{
                            marginTop: "8px", padding: "8px 10px",
                            background: "#F1C40F11", borderRadius: "4px",
                            border: "1px solid #F1C40F22", fontSize: "10px",
                ...
                {activeTab === "detected" && detected.length === 0 && (
                  <div style={{ textAlign: "center", padding: "40px 20px", color: "#2ECC71", fontSize: "12px" }}>
